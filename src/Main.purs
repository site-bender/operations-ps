...
import Sitebender (Operation, createFromArgumentOp, makeOperate)
...
argOp :: Operation String
argOp = createFromArgumentOp ""
...
main = do
  ...
  let getArg = makeOperate argOp
  s1 <- getArg $ Just "yo yo yo"
  log $ show s1
